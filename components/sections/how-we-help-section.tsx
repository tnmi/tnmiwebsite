  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-24">
        ...
        >
          {[
            { stat: "80%", label: "Reduced Menial Tasks", desc: "Augment the human creativity" },
            { stat: "60%+", label: "More Information", desc: "Information is Power for Decision Intelligence" },
            { stat: "35x+", label: "ROI Boost", desc: "Maximize value from investments." },
