import RequestToSellForm from "./request-to-sell-form"
import Link from "next/link"
import { ArrowLeft } from "lucide-react"

export default function RequestToSellPage() {
  return (
    <div className="min-h-screen bg-gradient-radial from-slate-900 via-slate-800 to-emerald-950 text-white flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-2xl bg-white/10 backdrop-blur-[14px] border border-white/20 rounded-[2rem] shadow-[inset_0_0_0.25rem_rgba(255,255,255,0.2),0_20px_40px_rgba(0,0,0,0.2)]">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold text-emerald-300 mb-3 drop-shadow">Sell on the True North Platform</h1>
          <p className="text-slate-200 text-lg">
            We sell advanced materials, chemicals and connect manufacturing, research institutes, and material innovations.
          </p>
        </div>
        <RequestToSellForm />
      </div>
